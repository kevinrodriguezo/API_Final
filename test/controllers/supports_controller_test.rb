...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { detalle: @support.detalle, estado: @support.estado, titulo: @support.titulo } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { detalle: @support.detalle, estado: @support.estado, titulo: @support.titulo } }
